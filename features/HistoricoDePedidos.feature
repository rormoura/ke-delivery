Feature: Histórico de pedidos
    ...
    Scenario 1: Visualizar os pedidos feitos nos últimos 10 dias (GUI)
    ...
    Scenario 2: Visualizar um pedido em uma data inválida (GUI) 
        Given Eu estou na página "Meus Pedidos"
    ...
    Scenario 3: Obter todos os pedidos feitos (SERVICE)
        ...
        And o pedido "03032023" com data "03/03/2023" com Status "Fnalizado" e valor total "R$57,33" está na lista
    ...
    Scenario 4: Obter pedido "15122023" (SERVICE)
        ...
        And a resposta deve conter o Status "Finalizado"
        And a resposta deve conter a data "15/12/2023"
        And a resposta deve conter a observação "Com molho extra"
        And a resposta deve conter valor total "R$43,14"
        And a resposta deve conter método de pagamento "Cartão de crédito VISA"
        And a resposta deve conter endereço "Casa da Torre"
        And a resposta deve conter entregue por "Carlos"
        And a resposta deve conter feito por "Mama Mia Massas"
