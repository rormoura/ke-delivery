...
Scenario: Cadastro de cliente
  Given Restaurant apresenta um JSON com id = "1", typeBusiness = "Restaurante", responsibleName = "Marina Melo", responsibleCPF = "12345678910", email = "gerencia@marinarestaurane.com.br", phone = "(88)912345678", password = "xxxxxxxxxyx", adress = "Rua Governaador Lopo Garro, 353", phoneRestaurant = "(81)21214545", corporateName = "Marina Massas", restaurantName = "Restaurante da Marina", CNPJ = "1234567891010", speciality = "Massas"
  When Uma requisição "POST"  for enviada para "restaurants" com id = "1", typeBusiness = "Restaurante", responsibleName = "Marina Melo", responsibleCPF = "12345678910", email = "gerencia@marinarestaurane.com.br", phone = "(88)912345678", password = "xxxxxxxxxyx", adress = "Rua Governaador Lopo Garro, 353", phoneRestaurant = "(81)21214545", corporateName = "Marina Massas", restaurantName = "Restaurante da Marina", CNPJ = "1234567891010", speciality = "Massas"
