Feature: Criação de Pedidos
    ...
    And o JSON tem Cliente = "111.111.111.11"
    And o JSON tem Data = "25/09/2020"
    And o JSON tem Endereco = "Rua Mauricéia, 358, Torre, Recife, Pernambuco, Brasil"
    And o JSON tem Entregador = "000.000.000.00"
    And o JSON deve ter item = "{nome = 'Tofu', quantidade = '2', VUnit = 'R$10,00', VTot = 'R$20,00'}"
    And o JSON tem MetodoDePagamento = "Cartão de Crédito VISA"
    And o JSON tem Observacoes = ""
    And o JSON tem Restaurante = "VegPower"
    And o JSON tem ValorTotal = "R$20,00"
    And o JSON tem Status = "Aguardando confirmação do restaurante"
